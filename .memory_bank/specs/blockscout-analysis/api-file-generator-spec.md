...
Use this index to find available endpoints for the `direct_api_call` Blockscout MCP tool. Each section links to a dedicated API file with full parameter details.
